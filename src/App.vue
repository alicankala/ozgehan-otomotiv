...
const checkIsOpen = () => {
  ...
  // Pazar kapalı, Pazartesi-Cumartesi 08:30-19:00 açık
...
<template>
  <div class="min-h-screen w-full bg-slate-100 text-slate-900 font-sans relative overflow-x-hidden pb-16 md:pb-0">
    ...
    <header class="bg-slate-950 text-white px-4 py-4 md:px-5 md:py-6 shadow-2xl sticky top-0 z-50 border-b border-slate-800">
  <div class="max-w-7xl mx-auto flex justify-between items-center gap-4">
    <div class="flex items-center justify-center md:justify-start gap-3 md:gap-3 min-w-0 flex-1">
      <div class="w-10 h-10 md:w-14 md:h-14 bg-red-700 rounded-xl flex items-center justify-center shrink-0">
      ...
      <div class="font-display text-2xl sm:text-3xl md:text-3xl font-black uppercase tracking-wide whitespace-nowrap leading-none scale-y-125 md:scale-y-125 origin-center md:origin-left">
  <span class="text-white">Özgehan</span>
  <span class="text-slate-400 ml-1 font-black">Otomotiv</span>
</div>
    </div>

    <div class="hidden md:flex items-center gap-3 md:gap-4 shrink-0">
      <span class="text-slate-400 hidden xl:flex items-center gap-2 text-sm font-medium whitespace-nowrap">
      ...
      <a href="tel:05326213429" class="font-bold text-xs sm:text-base bg-red-700 px-2 sm:px-5 py-2 sm:py-2.5 rounded-full hover:bg-red-600 transition-all flex items-center gap-1 sm:gap-2 shadow-inner whitespace-nowrap hover:scale-105 active:scale-95">
