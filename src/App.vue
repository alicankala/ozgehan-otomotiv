...
<template>
  ...
  <div class="max-w-7xl mx-auto flex justify-between items-center gap-4">
    <div class="flex items-center gap-2.5 md:gap-3 min-w-0 flex-1">
      ...
      <div class="font-display text-xl sm:text-2xl md:text-3xl font-black uppercase tracking-wide whitespace-nowrap leading-none scale-y-125 origin-left">
  ...
  <span class="text-slate-400 ml-1 font-black">Otomotiv</span>
    ...
    <div class="flex items-center gap-3 md:gap-4 shrink-0">
      ...
      <a href="tel:05326213429" class="font-bold text-xs sm:text-base bg-red-700 px-2.5 sm:px-5 py-2 sm:py-2.5 rounded-full hover:bg-red-600 transition-all flex items-center gap-1.5 sm:gap-2 shadow-inner whitespace-nowrap hover:scale-105 active:scale-95">
