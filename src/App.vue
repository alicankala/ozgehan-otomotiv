    ...
    <div class="text-center md:text-left flex flex-col items-center md:items-start">
      ...
      <h1 class="soft-fade-up text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-950 leading-[1.08] mb-5 md:mb-6 tracking-tight">
        ...
        <div class="w-full h-[260px] sm:h-[360px] md:h-[460px] bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border-4 md:border-8 border-slate-100 mt-4 md:mt-0 relative group">
          <img :src="heroFoto" alt="Ankara Mega Şaşmaz Özgehan Otomotiv motor mekanik ve oto bakım servisi" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"/>
          <div
