...
const callOptions = [
  ...
  {
    name: 'Bünyamin Kala',
    phone: '0505 858 65 91',
    href: 'tel:05058586591'
  },
  {
    name: 'Yusuf Kala',
    phone: '0507 727 67 16',
...
<div class="text-center md:text-left">
      <h1 class="soft-fade-up text-[38px] sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-950 leading-[1.05] mb-4 md:mb-6 tracking-tight">
        ...
        <span class="text-red-700 relative inline-block font-bold">
          ...
          <div class="grid grid-cols-3 gap-2 md:gap-3 w-full max-w-[520px]">
  <a
    href="https://wa.me/905326213429?text=Merhaba,%20%C3%96zgehan%20Otomotiv%20sitenizden%20ula%C5%9F%C4%B1yorum."
    target="_blank"
    class="inline-flex items-center justify-center gap-1.5 md:gap-2 px-2.5 md:px-5 py-3 md:py-3.5 text-xs md:text-sm font-black text-white transition-all bg-emerald-600 rounded-2xl shadow-md shadow-emerald-900/10 hover:bg-emerald-700 hover:-translate-y-0.5 active:translate-y-0"
  >
    <svg class="w-4 h-4 md:w-5 md:h-5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
  ...
  <button
    ...
    class="inline-flex items-center justify-center gap-1.5 md:gap-2 px-2.5 md:px-5 py-3 md:py-3.5 text-xs md:text-sm font-black text-white transition-all bg-red-700 rounded-2xl shadow-md shadow-red-900/10 hover:bg-red-600 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
  >
    <svg class="w-4 h-4 md:w-5 md:h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.94.725l.548 2.2a1 1 0 01-.321.988l-1.305.98a10.582 10.582 0 004.872 4.872l.98-1.305a1 1 0 01.988-.321l2.2.548a1 1 0 01.725.94V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
    </svg>
    <span class="truncate">Hemen Ara</span>
  </button>
...
<section class="py-8 md:py-10 bg-white border-b border-slate-200">
  <div class="max-w-4xl mx-auto px-4">
    <div class="reveal bg-slate-50 border border-slate-200 rounded-3xl p-5 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
      ...
      <a
  href="https://g.page/r/Cej7t2Brkk6VEAE/review"
  target="_blank"
    ...
    <div class="w-full max-w-sm bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-200 mb-safe">
      <div class="p-5 border-b border-slate-100 flex items-center justify-between">
        <div>
          ...
          <p class="text-sm text-slate-500 mt-1">Özgehan Otomotiv telefonları</p>
        </div>

        <button
          type="button"
          @click="showCallOptions = false"
          class="w-9 h-9 rounded-full bg-slate-100 text-slate-600 hover:bg-slate-200 flex items-center justify-center text-xl font-black cursor-pointer"
        >
          ×
        </button>
      </div>
      ...
      <div class="p-3">
        <a
          v-for="person in callOptions"
          :key="person.phone"
          :href="person.href"
          class="flex items-center justify-between gap-4 p-4 rounded-2xl hover:bg-slate-100 active:bg-slate-200 transition-colors"
        >
          <div>
            <div class="font-black text-slate-950">{{ person.name }}</div>
            <div class="text-sm text-slate-500 mt-0.5">{{ person.phone }}</div>
          </div>

          <div class="w-10 h-10 rounded-full bg-red-700 text-white flex items-center justify-center shrink-0">
