...
<template>
  ...
  <div class="max-w-7xl mx-auto flex justify-between items-center gap-4">
    <div class="flex items-center gap-2 md:gap-3 min-w-0 flex-1 overflow-hidden">
      ...
      <div class="font-display text-[15px] sm:text-xl md:text-3xl font-black uppercase tracking-wide whitespace-nowrap leading-none md:scale-y-125 origin-left">
