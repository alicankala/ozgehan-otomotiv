      ...
      <div class="max-w-4xl mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12 reveal">
          ...
          <div class="text-center md:text-left">
            ...
            <p class="text-lg text-slate-600 leading-relaxed">Özgehan Otomotiv, Ankara <strong class="text-slate-900">Mega Şaşmaz'da</strong> uzun yıllara dayanan sektörel tecrübe ve çekirdekten yetişme profesyonel usta kadrosuyla hizmet vermektedir. Kurulduğumuz günden bu yana temel ilkemizdürüstlük, şeffaf fiyatlandırma ve garantili usta işçiliğidir.</p>
          </div>
        </div>
      </div>
    </section>
